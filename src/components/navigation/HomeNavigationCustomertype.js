...
import Explore_Customer from "../screen/Explore_Customer";
import SearchScreen from "../screen/SearchScreen";
import Profile_CustomerScreen from "../screen/Profile_CustomerScreen";
import EventDetail_Customer from "../screen/EventDetail_Customer";
import SaleScreen from "../screen/SaleScreen";
import SettingCustomerScreen from "../screen/SettingCustomerScreen";
...
import DownloadPhoto from "../screen/DownloadPhoto";
...
//         transition == "ImagedetailDownload" ||
...
const ExploreStack = createStackNavigator(
  {
    Explore: {
      screen: Explore_Customer
    },
    Eventdetail: {
      screen: EventDetail_Customer
    },
    Imagedetail: {
...
const ProfileStack = createStackNavigator(
  {
    Profile: {
      screen: Profile_CustomerScreen
    },
    Salesdetail: {
      screen: SaleScreen
    },
    Settingprofile: {
      screen: SettingCustomerScreen
    },
    ImagedetailDownload: {
      screen: DownloadPhoto
    },
    Imagedetail: {
      screen: ImageinfoScreen
    },
