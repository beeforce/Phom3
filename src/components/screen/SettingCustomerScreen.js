...
export default class SettingCustomerScreen extends Component {
  ...
  render() {
    return (
      <View style = {styles.container}>
        ...
        <Icon name = "chevron-right" color = '#5a5a5a' size = {15} style = {{alignSelf: 'center'}} />
        </View>
        </TouchableHighlight>
        </View>
        ...
        <View style = {{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline'}}>
        <Text style = {styles.texttitle}>เปลี่ยนเป็นผู้ขายภาพ</Text>
        <Icon name = "chevron-right" color = '#5a5a5a' size = {15} style = {{alignSelf: 'center'}} />
        </View>
        </TouchableHighlight>
        </View>
